...
export default function Footer() {
  return (
    <>
      <hr className="mt-2 border-gray-200 sm:mx-auto lg:mt-2" />
        <footer className="bg-transparent w-full lg:px-20 px-4 py-2 lg:py-2">
            <div className="sm:flex sm:items-center sm:justify-between">
                <Link href="/Components/home" className="flex items-center">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Portofolio</span>
                </Link>
                <span className="text-sm text-gray-500 sm:text-center dark:text-white">© 2023 <a href="https://flowbite.com/" className="hover:underline">Flowbite™</a>. All Rights Reserved.
                </span>
                <div className="flex pt-1 space-x-6 sm:justify-center sm:mt-0">
                    <a href="https://www.facebook.com/" className="text-black dark:text-white border-white rounded-full">
                    ...
                    <a href="https://www.instagram.com/" className="text-black dark:text-white border-white rounded-full">
                    ...
                    <a href="https://www.twitter.com/" className="text-black dark:text-white border-white rounded-full">
                    ...
                    <a href="https://github.com/Mubashir34827" className="text-black dark:text-white border-white rounded-full">
