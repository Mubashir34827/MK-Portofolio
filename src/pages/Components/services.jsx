...
export default function Services() {
    return (
    <>
        <section className="text-gray-600 dark:text-gray-100 body-font lg:mx-20 md:mx-10 sm:mx-10 xs:mx-5 mt-10">
            <div className="container-fluid lg:px-12 lg:py-6 xs:py-10 sm:py-10 md:py-10 mx-auto">
                ...
                <div className="flex flex-wrap -m-4 dark:text-gray-950">
                    {services.map((item) => (
                        <div key={item.id} className="lg:px-4 lg:py-2 px-4 md:py-2 py-4 lg:w-1/4 md:w-1/3 sm:w-1/2 w-full">
